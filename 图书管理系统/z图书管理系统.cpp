...
void del(Book* head);//删除 
void insert(Book *head);//插入
void mod(Book* head);//修改
void printBook(Book *head) ;//输出 
void searchByAuthor(Book* head);//通过作者名查询 
void searchById(Book* head);//通过序号查询 
void searchByName(Book* head);//通过书名查询 
void sortById(Book* head);//通过编号自动排序 
void printMainMenu();//菜单界面 
void printSearchMenu();//搜索菜单界面  
void choose();//选择功能
int load();//登录功能
